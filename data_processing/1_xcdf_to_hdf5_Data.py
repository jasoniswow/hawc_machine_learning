...
infile = xcdf.XCDFFile("data_input/data_hadron_combined.xcd")
...
hdf = pd.HDFStore('data_input/data_hadron_combined.h5')
hdf.put('data_hadron', p, format='table', data_columns=True)
hdf.close()
