...
# For this problem, we can have 7 to more than 20 input features, with 3 output classes.
...
def rejection(precision_w_GG, pred_GG, true_nonGG, weights):
    ...
    for epoch in range(1, training_epochs+1):
        ...
        if (epoch % display_step == 0 or epoch == 1):
            ...
            if (epoch == training_epochs):
                ...
                final_indicators.append("Precision(Bkg_w): %.4f, %.4f \n"%(preBG_w_tr,preH_w_tr))
                final_indicators.append("Recall(Sig_w):    %.4f \n"%(reGG_w_tr))
                final_indicators.append("Recall(Bkg_w):    %.4f, %.4f \n"%(reBG_w_tr,reH_w_tr))
...
print ( "Write all variables to xml file ===============================================================" )
'''
